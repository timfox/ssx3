...
| Matching C (`obj/current`) | **744** `@objdiff-matched` units; **219** readable EE C (`auto_try_jr_delay_*`, `func_0034FC78` back-link); tiny stubs via `bulk_generate_tiny_ps2_units.py` |
