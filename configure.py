...
NATIVE_HOST_SOURCES_BASE = [
    ...
    "src/platform/linux/host_menu_layout.cpp",
    ...
    "src/platform/linux/host_io.cpp",
    "src/platform/linux/host_bigfile.cpp",
    "src/platform/linux/host_graphics.cpp",
    "src/platform/linux/host_gs.cpp",
    "src/platform/linux/host_pad.cpp",
    "src/platform/linux/host_input.cpp",
    "src/platform/linux/host_boot.cpp",
    "src/platform/linux/host_cpp_runtime.cpp",
    "src/platform/linux/host_ssxapp.cpp",
    "src/platform/linux/host_fe_title.cpp",
    "src/platform/linux/host_fe_mainmenu.cpp",
    "src/platform/linux/host_fe_context.cpp",
    "src/platform/linux/host_fe_session.cpp",
    "src/platform/linux/host_fe_flow.cpp",
